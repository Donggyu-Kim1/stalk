...
urlpatterns = [
    ...
    path('<str:ticker>/<int:post_id>/', views.PostReadView.as_view(), name='post_read'),  # 글 읽기
    path('<str:ticker>/<int:post_id>/detail/', views.PostDetailView.as_view(), name='post_detail'),  # 글 추천, 조회수
    ...
    path('<str:ticker>/<int:post_id>/comments/create/', views.PostCommentCreateView.as_view(), name='post_comment_create'),  # 댓글/대댓글 작성
    path('<str:ticker>/<int:post_id>/comments/<int:comment_id>/', views.PostCommentDetailView.as_view(), name='post_comment_detail'),  # 댓글 수정/삭제
]
